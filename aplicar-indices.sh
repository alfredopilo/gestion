...
echo "  • idx_user_institution_deleted"
echo "  • idx_user_role_institution"
echo "  • idx_student_institution_status_deleted"
echo "  • idx_student_course_status"
echo "  • idx_student_name_search"
echo "  • idx_course_institution_deleted"
echo "  • idx_course_school_year"
echo "  • idx_payment_deleted"
echo "  • idx_payment_student_status"
echo "  • idx_payment_date_status"
echo "  • idx_grade_student_subject"
echo "  • idx_grade_period"
echo "  • idx_attendance_student_date"
echo "  • idx_attendance_course_date"
echo "  • idx_subject_assignment_teacher"
echo "  • idx_subject_assignment_course"
